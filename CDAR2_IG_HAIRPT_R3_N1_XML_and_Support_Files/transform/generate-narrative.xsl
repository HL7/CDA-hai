...
<!-- Created by Lantana Consulting Group February 2008
        ...
        Update December 2016 for R3D2
        Update February 2017 for R3D2
        Update June 2017 for R3D2
        Update October 2018 for R3D3
        Update August 2019 for R3D4
        Update August 2020 for R3N1
 -->
<!-- ============================================================== -->
<!-- ============================================================== -->
...
<!-- ============================================================== -->
<!-- ============================================================== -->
<xsl:transform version="1.0" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:voc="http://www.lantanagroup.com/voc" exclude-result-prefixes="cda" xmlns:sdtc="urn:hl7-org:sdtc" >
    ...
    <!-- Note: Does not strip space in ClinicalDocument, structuredBody, component,
            ...
            readability. -->
    <xsl:strip-space elements="cda:recordTarget cda:patientRole cda:patient cda:name cda:author cda:assignedAuthor cda:custodian cda:assignedCustodian cda:representedCustodianOrganization cda:legalAuthenticator cda:assignedEntity cda:performer cda:componentOf cda:encompassingEncounter cda:effectiveTime cda:location cda:healthCareFacility cda:addr cda:act cda:procedure cda:observation cda:entry cda:organizer cda:component cda:entryRelationship cda:participant cda:participantRole cda:playingDevice cda:manufacturedMaterial cda:manufacturedProduct cda:consumable cda:substanceAdministration" />
 ...
 narrative block, change this template accordingly. -->
    ...
    <xsl:template match="/cda:ClinicalDocument/cda:component/cda:structuredBody /cda:component/cda:section">
        <xsl:copy>
            ...
            <text>
                ...
                <xsl:choose>
                    <!--
                     ...
                     -->
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.5.34' or cda:templateId/@root='2.16.840.1.113883.10.20.5.5.32' or
            ...
            <xsl:apply-templates select="*[ not( self::cda:title | self::cda:code | self::cda:templateId | self::cda:text)] | comment()[
                not(following-sibling::*[self::cda:text]) and not(following-sibling::*[self::cda:section])]" />
            <!--<xsl:apply-templates
 ...
 />-->
    ...
    <xsl:template name="start-section">
        <xsl:copy-of select="*[ ( self::cda:title | self::cda:code | self::cda:templateId)] | @* | comment()[following-sibling::cda:text]" />
 ...
 <xsl:value-of select="cda:title" />
    ...
    <xsl:template match="*[not(self::ClinicalDocument) and not(self::cda:section)] [cda:templateId][not(
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.188' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.201' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.189' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.187' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.190' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.177' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.200' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.186' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.175' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.233' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.232' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.236' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.235' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.234' )]" mode="generate-narrative">
        <xsl:choose>
 ...
 -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.2.1.1.1' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.170' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.123' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.160' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.2.5.2' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.120' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.25' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.150' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.159' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.163' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.125' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.121' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.142' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.148' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.138' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.171' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.203' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.204' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.205' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.206' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.209' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.222' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.225' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.231' or 
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.248'">
 ...
 -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.113' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.145' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.114' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.135' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.139' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.144' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.132' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.168' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.166' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.113' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.263'">
                <xsl:call-template name="pattern-3" />
            </xsl:when>
 ...
 Value = process the value element
 -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.174' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.131' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.173' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.127' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.126' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.137' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.146' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.185' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.192' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.195' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.207' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.216' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.219' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.221' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.229' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.255'">
 ...
 -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.128' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.130' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.129' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.133' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.141' ">
                <xsl:call-template name="pattern-5" />
            </xsl:when>
            <!-- Not-patterned (exception) handling -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.2.2.7.2' or cda:templateId/@root='2.16.840.1.113883.10.20.5.2.2.7.3' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.147' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.115' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.116' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.119' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.180' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.136' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.154' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.158' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.161' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.183' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.164' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.165' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.167' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.151' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.220' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.218' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.156' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.172' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.181' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.169' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.157' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.149' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.155' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.124' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.104' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.122' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.106' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.153.2' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.184' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.191' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.241' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.193' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.196' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.197' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.198' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.199' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.211' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.212' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.208' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.213' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.214' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.215' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.224' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.226' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.217' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.112' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.228' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.140' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.230' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.239' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.194' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.242' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.243' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.245' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.246' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.247' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.257' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.249' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.244' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.262' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.261' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.270'">
 ...
 an organizer explicitly, list it above as an exception pattern. -->
            ...
            <xsl:when test="self::cda:organizer or self::cda:encounter or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.2' or
                cda:templateId/@root='2.16.840.1.113883.10.20.22.4.4' or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.14' or
                cda:templateId/@root='2.16.840.1.113883.10.20.22.4.16' or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.19' or
                cda:templateId/@root='2.16.840.1.113883.10.20.22.4.27' or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.49' or
                cda:templateId/@root='2.16.840.1.113883.10.20.22.4.79' or cda:templateId/@root='2.16.840.1.113883.10.20.22.4.12'">
                <xsl:apply-templates select="*" mode="generate-narrative" />
            </xsl:when>
 ...
 -->
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.1.53' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.134' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.168' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.162' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.176' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.202' or
                cda:templateId/@root='2.16.840.1.113883.10.20.22.4.23' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.227' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.237' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.238' or
                cda:templateId/@root='2.16.840.1.113883.10.20.5.6.240' " />
            <!-- default = diagnostic -->
            <xsl:otherwise>
                <tr>
...
-->
    ...
    <xsl:template name="pattern-3">
        <tr>
            <td>
                <!-- put out the appropriate NHSN label for the observation -->
                <xsl:choose>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.2.2.3'">BSI type</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.113'">ASA class</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.145'">Microorganism identified</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.114'">Bloodstream infection evidence type</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.135' and ../../cda:templateId/@root='2.16.840.1.113883.10.20.5.6.263'">SSI Level</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.135'">Infection condition</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.139'">Infection type</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.263'">Infection type</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.144'">Occasion of HAI Detection</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.132'">History of object presence</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.168'">......Suspected source of pathogen</xsl:when>
                    <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.166'">Spinal Fusion Level</xsl:when>
                </xsl:choose>
            </td>
            <td>
                <!-- change context node -->
                ...
                <xsl:for-each select="cda:value | cda:interpretationCode">
                    <xsl:choose>
                        ...
                        <xsl:when test="@xsi:type='IVL_PQ'">
                            <xsl:choose>
                                <xsl:when test="cda:low and cda:low/@inclusive='true'">Greater than or equal to <xsl:for-each select="cda:low">
                                        <xsl:call-template name="getQuantity" />
                                    </xsl:for-each></xsl:when>
                                <xsl:when test="cda:low and not(cda:low/@inclusive='true')">Greater than <xsl:for-each select="cda:low">
                                        <xsl:call-template name="getQuantity" />
                                    </xsl:for-each></xsl:when>
                                <xsl:when test="cda:high and not(cda:high/@inclusive='true')">Less than <xsl:for-each select="cda:high">
                                        <xsl:call-template name="getQuantity" />
                                    </xsl:for-each></xsl:when>
                                <xsl:when test="cda:high and cda:high/@inclusive='true'">Less than or equal to <xsl:for-each select="cda:high">
                                        <xsl:call-template name="getQuantity" />
                                    </xsl:for-each></xsl:when>
 ...
 Used also in a couple of exception patterns. -->
                    <xsl:if test="preceding-sibling::cda:templateId[@root='2.16.840.1.113883.10.20.5.6.140' or
                        @root='2.16.840.1.113883.10.20.5.6.141']">
                        <xsl:text>...</xsl:text>
                    </xsl:if>
                    <xsl:call-template name="getDisplayName" />
                    <xsl:text> </xsl:text>
 ...
 other summary encounters-->
    <xsl:template match="cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.184' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.191' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.241' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.193' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.196' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.199' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.213' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.214' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.215' ]" mode="exceptions">
        <xsl:choose>
            <!-- special case: AURP - some minor data first, then the main data -->
            <xsl:when test="/cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:code
  ...
  <xsl:template match="cda:encounter[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.262']" mode="exceptions">
        <!-- the in-facility location -->
        <tr>
          <td>Location</td>
          <td>
            <!-- change context node -->
            <xsl:for-each select="cda:participant[@typeCode='LOC']/cda:participantRole[@classCode='SDLOC']/cda:code">
              <xsl:call-template name="getDisplayName" />
            </xsl:for-each>
          </td>
        </tr>
        <!-- Date admitted or transferred -->
        <tr>
        ...
        <tr>
          ...
          <td>
            <xsl:for-each select="sdtc:dischargeDispositionCode">
              <xsl:call-template name="getDisplayName" />
            </xsl:for-each>
          </td>
        </tr>
  ...
  <!-- SSI Detection Method -->
  <xsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.261']" mode="exceptions">
    <tr>
    ...
    <!-- COVID-19 -->
    <xsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.270']" mode="exceptions">
        <tr>
            <td>COVID-19</td>
            <td>
                <xsl:choose>
                    <xsl:when test="cda:value/@code='1240591000000102'">No</xsl:when>
                </xsl:choose>
                <xsl:choose>
                    <xsl:when test="cda:value/@code='840539006'">Yes - COVID-19 Confirmed</xsl:when>
                </xsl:choose>
                <xsl:choose>
                    <xsl:when test="cda:value/@code='840544004'">Yes - COVID-19 Suspected</xsl:when>
                </xsl:choose>
            </td>
        </tr>
    </xsl:template>
 ...
 Used also in a couple of exception patterns. -->
  ...
  <!-- Pattern Exception: Inborn/Outborn Observation 2.16.840.1.113883.10.20.5.6.257-->
  <xsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.257']" mode="exceptions">
        <tr>
          <td>Inborn/Outborn</td>
            
          <td>
            <xsl:choose>
              <xsl:when test="@negationInd='true'">Inborn</xsl:when>
              <xsl:when test="@negationInd='false'">Outborn</xsl:when>
            </xsl:choose>
          </td>
        </tr>
    <xsl:apply-templates select="*" mode="generate-narrative" />
 ...
 and is several levels down. -->
    <xsl:template match="*[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.106' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.112']"
        mode="exceptions">
        <tr>
            <td>
                <!-- change context node -->
 ...
 transform will kick out a diagnostic unless they're handled explicitly. -->
    <xsl:template match="*[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.154' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.156' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.155' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.104' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.122' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.153.2' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.117' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.211' ]" mode="exceptions">
        <xsl:apply-templates select="*" mode="generate-narrative" />
    </xsl:template>
 ...
 part of step 1 within CLI protocol. ...20.5.6.83 -->
  ...
  <!-- Pattern Exception: 
              Hemodialysis Catheter Present, 
              Extracorporeal Life Support Present, 
              Ventricular Assist Device (VAD) Present  -->
  <xsl:template match="cda:procedure[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.245' or
    cda:templateId/@root='2.16.840.1.113883.10.20.5.6.246' or
    cda:templateId/@root='2.16.840.1.113883.10.20.5.6.247']" mode="exceptions">
    <tr>
      <!--<td>
 ...
 entryRelationship/observation/@nullFlavor is UNK, then the date the infection began is unknown. -->
    ...
    <!-- Pattern Exception: Vaccination Type Observation 2.16.840.1.113883.10.20.5.6.242 -->
    <xsl:template match="cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.242']" mode="exceptions">
        <tr>
        ...
        <tr>
            <td>... Subtype</td>
            <td>
                <xsl:for-each select="cda:value/cda:qualifier/cda:value">
                    <xsl:text>... </xsl:text>
                    <xsl:call-template name="getDisplayName" />
                </xsl:for-each>
            </td>
    ...
    <!-- Pattern Exception: Comment 2.16.840.1.113883.10.20.5.6.243 -->
    <xsl:template match="cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.243']" mode="exceptions">
        <tr>
            <td>Comment</td>
            <td>
  ...
  <!-- Pattern Exception: Report No Events 2.16.840.1.113883.10.20.5.6.249 -->
  <xsl:template match="cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.249']" mode="exceptions">
    <tr>
  ...
  <xsl:template match="cda:procedure/cda:code" mode="generate-narrative">
    ...
    <xsl:template match="cda:procedure[not(cda:templateId/@root='2.16.840.1.113883.10.20.5.6.188')]/cda:effectiveTime[not(cda:low) and
        not(cda:width)]" mode="generate-narrative">
        <tr>
            <td>Procedure date</td>
            <td>
                <xsl:apply-templates select="@value" mode="format-date" />
 ...
 also displays the admission status, from the header -->
    <xsl:template match="cda:procedure/cda:effectiveTime/cda:width [/cda:ClinicalDocument/cda:templateId/@root='2.16.840.1.113883.10.20.5.3.4']"
        ...
        <tr>
            ...
            <td>
                <!-- change context node -->
                <xsl:for-each select="/cda:ClinicalDocument/cda:componentOf/cda:encompassingEncounter /cda:code">
                    <xsl:call-template name="getDisplayName" />
                </xsl:for-each>
            </td>
        </tr>
  ...
  <!-- effectiveTime in an Infection Type Observation SSI...5.6.263 -->
  <xsl:template match="cda:effectiveTime[../cda:templateId/@root='2.16.840.1.113883.10.20.5.6.263']" mode="generate-narrative">
    <tr>
      <td>Date of infection</td>
      <td>
        <xsl:apply-templates select="cda:low/@value" mode="format-date" />
    ...
    <xsl:template match="cda:effectiveTime [../cda:templateId/@root='2.16.840.1.113883.10.20.5.6.144']" mode="generate-narrative">
        <tr>
            <td>Date of infection</td>
            <td>
                <xsl:apply-templates select="@value" mode="format-date" />
        ...
        <tr>
            ...
            <td>
                <xsl:choose>
                    ...
                    <xsl:when test="$the-valuesets/*/*/voc:code[@codeSystem='2.16.840.1.113883.6.277'] [@value=current()/@code]">
                        <xsl:for-each select="$the-valuesets/*/*/voc:code[@codeSystem='2.16.840.1.113883.6.277'] [@value=current()/@code]">
 ...
 and use negationInd for the truthValue -->
    ...
    <xsl:template match="cda:methodCode[@codeSystem='2.16.840.1.113883.6.96'] [@code='373110003']" mode="generate-narrative">
        <tr>
...
-->
  ...
  <!-- Mechanical Ventilation Initiation Act (2.16.840.1.113883.10.20.5.6.244) -->
  <xsl:template match="cda:act[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.244']" mode="exceptions">    
    <tr>
      <td>Mechanical ventilation initiation date</td>
      <td><xsl:apply-templates select="cda:effectiveTime/cda:low/@value" mode="format-date" /></td>
      
    </tr>
    <tr>
      <td>Location of patient when mechanical ventilation was initiated</td>
      <td><xsl:apply-templates select="//cda:participant[@typeCode='LOC']/cda:participantRole[@classCode='SDLOC']"
        mode="process-element" /></td>
    </tr>
  </xsl:template>
...
-->
 ...
 <xsl:value-of select="$the-valuesets/*/*[@codeSystem=''][@valueSetOID='']/*[@value=$this-code]/@displayName"/>
    ...
    <xsl:template match="cda:id" mode="show-id">
        ...
        <xsl:if test="not(contains(@root,
            /cda:ClinicalDocument/cda:participant[@typeCode='LOC']/cda:associatedEntity[@classCode='SDLOC']/cda:id/@root))">
            <xsl:text> (Facility </xsl:text>
...
-->
    ...
    <xsl:template match="*[not(self::ClinicalDocument) and not(self::cda:section)][cda:templateId]
        [cda:templateId/@root='2.16.840.1.113883.10.20.5.6.188' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.201' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.187' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.189' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.177' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.200' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.186' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.175' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.236' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.232' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.235' or cda:templateId/@root='2.16.840.1.113883.10.20.5.6.233' or
        cda:templateId/@root='2.16.840.1.113883.10.20.5.6.234' ]" mode="generate-narrative">
        ...
        <xsl:choose>
            ...
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.232'">
                <table border="1">
                    <tbody>
                        <tr>
                            <td>Facility: <xsl:apply-templates select="//cda:participant[@typeCode='LOC']/cda:participantRole[@classCode='SDLOC']"
                        ...
                        <tr>
                            <xsl:apply-templates
                                select="ancestor::*/cda:entry/cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.233']"
                                mode="exceptions" />
                        </tr>
                    </tbody>
                </table>
            ...
            <xsl:when test="cda:templateId/@root='2.16.840.1.113883.10.20.5.6.236'">
                ...
                <table border="1">
                    <tbody>
                        ...
                        <xsl:apply-templates
                            select="ancestor::*/cda:entryRelationship/cda:observation[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.235']"
                            mode="exceptions" />
 ...
 <xsl:call-template name="getDisplayName"/>
    ...
    <xsl:template match="cda:procedure[cda:templateId/@root='2.16.840.1.113883.10.20.5.6.188']" mode="exceptions">
        <tr>
            ...
            <td>
                <xsl:apply-templates
                    select="cda:entryRelationship/cda:encounter/cda:participant[@typeCode='LOC']/cda:participantRole[@classCode='SDLOC']"
                    mode="process-element" />
            </td>
        </tr>
        <tr>
    ...
    <xsl:template match="cda:value[not(@xsi:type='CD')]" mode="generate-value">
        <xsl:choose>
            ...
            <xsl:when test="@xsi:type='IVL_PQ'">
                <xsl:choose>
                    <xsl:when test="cda:low and cda:low/@inclusive='true'">Greater than or equal to <xsl:apply-templates select="cda:low"
                            mode="get-quantity" />
                    </xsl:when>
                    ...
                    <xsl:when test="cda:high and cda:high/@inclusive='true'">Less than or equal to <xsl:apply-templates select="cda:high"
                            mode="get-quantity" />
                    </xsl:when>
